...
{{--Script de modals para editar,borrar la informacion de un registro de pago --}}
<script src="./js/modal-pagos.js"></script>

{{--Script de modals para editar,borrar la informacion de un registro clinico --}}
<script src="./js/modal-resumenclinico.js"></script>
