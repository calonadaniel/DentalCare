...
function modaldata(str_action) {
    ...
    $('#Modal-pago-'+str_action).on('show.bs.modal', function(event){
        ...
        if(str_action == "delete"){
            ...
            var modal = $(this);
            modal.find('.modal-body #'+str_action+'_id_pago').val(id_pago)
        ...
        modal.find('.modal-body #'+str_action+'_id_expediente').val(id_expediente)
        modal.find('.modal-body #'+str_action+'_id_pago').val(id_pago)
        modal.find('.modal-body #'+str_action+'_cuota').val(cuota)
    ...
    function validateform(action) {
        $('#pagosform-'+ action).parsley().on('field:validated', function() {
